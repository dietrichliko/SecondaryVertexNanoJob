...
# with command line options: NANO --step NANO --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --era Run2_2018,run2_nanoAOD_102Xv1 --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --number -1 --no_exec --python_filename Proposal_MiniAOD_To_NanoAOD.py
...
# Schedule definition
process.schedule = cms.Schedule(process.nanoAOD_step,process.endjob_step,process.MINIAODSIMoutput_step)
